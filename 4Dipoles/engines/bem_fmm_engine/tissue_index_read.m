function [name, tissue, cond, enclosingTissueIdx] = tissue_index_read(index_name, mesh_path)
...
%   Copyright WAW/SNM 2019-2020
    ...
    [index_dir, ~, ~]=fileparts(index_name);
    if(index_file<0)
    ...
    while ~feof(index_file)
        ...
        tempFileName = fullfile(mesh_path,tempFileName);
