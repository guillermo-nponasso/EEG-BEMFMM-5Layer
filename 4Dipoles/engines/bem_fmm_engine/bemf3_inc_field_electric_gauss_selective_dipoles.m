function [Epri, Ppri] = bemf3_inc_field_electric_gauss_selective_dipoles(strdipolePplus, strdipolePminus, strdipolesig, strdipoleCurrent, P, t, Center, dipoleClusterCenter, gaussRadius)    
    ...
    [Epri(~trianglesToSubdiv, :), Ppri(~trianglesToSubdiv, :)] = bemf3_inc_field_electric_plain_dipoles(strdipolePplus, strdipolePminus, strdipolesig, strdipoleCurrent, Center(~trianglesToSubdiv, :));
