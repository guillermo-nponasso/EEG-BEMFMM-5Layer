function [PC, integralpd] = meshneighborints_Pn(P, t, normals, Area, Center, RnumberP, ineighborP, Indicator, numThreads)
...
%   Copyright SNM 2018-2022
    ...
    if gauss == 0;  [coeffS, weightsS, IndexS]  = tri(7);      end;
    ...
    for n = 1:M                  %   inner integral; (n =1 - first column of the system matrix, etc.)        
        r1      = P(t(n, 1), :);    %   [1x3]
        r2      = P(t(n, 2), :);    %   [1x3]
        r3      = P(t(n, 3), :);    %   [1x3]  
