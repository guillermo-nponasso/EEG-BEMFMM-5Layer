...
fprintf("PROCESSING AMR DIPOLE FITTING FOR DIPOLE %s. PLEASE WAIT..",dipole_name);
disp(".......................................................");
...
dist_dip = 1e3*norm(dip.dip.pos-dip0.dip.pos); %mm
...
dip_equal=0;
if do_grid_fit
    dist_grid = 1e3*norm(dip_grid.dip.pos-dip0.dip.pos); %mm
...
data_cell(1,1:end)={patno,model_name,dipole_name,dist_dip, fit_angle, dip_mom, strength_re, ...
    dip.dip.rv(1),is_grid, dip_equal, total_adapt_steps};
...
writetable(data_table, ...
    ...
    strcat(patno,'_',model_name,'_',dipole_name,'_amr_table.csv')),'WriteMode','overwrite');
