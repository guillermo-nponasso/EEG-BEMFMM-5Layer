...
line_extremes_XY = [dipole_center_XY - 3*delta_dip_pos*dip_dir_XY; dipole_center_XY + 3*delta_dip_pos*dip_dir_XY];
perp_line_extremes_XY = [dipole_center_XY - 3*delta_dip_pos*dip_normal_XY; dipole_center_XY + 3*delta_dip_pos*dip_normal_XY];
