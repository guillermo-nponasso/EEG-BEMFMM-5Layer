...
tic
gaussRadius = 2*R;
[Epri, Ppri] = bemf3_inc_field_electric_gauss_selective_dipoles(strdipolePplus, strdipolePminus, strdipolesig, strdipoleCurrent, P, t, Center, ClusterCenter, gaussRadius, prec);
