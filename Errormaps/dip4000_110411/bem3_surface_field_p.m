...
%save(strcat('pot_', num2str(main), '.mat'), 'PtotSkin');

if ~isfolder(fullfile('data/clusters/potentials/', num2str(NC)))
    mkdir(fullfile('data/clusters/potentials/',num2str(NC)));
end
save(fullfile('data/clusters/potentials',num2str(NC),sprintf("pot_%d.mat", main)),'PtotSkin');